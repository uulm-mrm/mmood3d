...
from mmood3d.models.dense_heads.centerpoint_head import CustomCenterHead
...
from mmood3d.models.task_modules.coders.centerpoint_bbox_coders import \
    CustomCenterPointBBoxCoder
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            type=CustomCenterPointBBoxCoder,
