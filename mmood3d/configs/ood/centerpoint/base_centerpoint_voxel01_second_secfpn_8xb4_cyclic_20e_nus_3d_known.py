...
with read_base():
    from ..datasets.base_nus_3d_known import *
    from ..._base_.models.centerpoint_voxel01_second_secfpn_nus import *
    from ..._base_.schedules.cyclic_20e import *
    from ..._base_.default_runtime import *

from mmengine.hooks.empty_cache_hook import EmptyCacheHook
from mmengine.dataset.sampler import DefaultSampler

from mmdet3d.datasets.dataset_wrappers import CBGSDataset
from mmood3d.datasets.transforms.formating import Pack3DDetInputs
...
from mmood3d.datasets.ood_nuscenes_dataset import NuScenesOODDataset
...
train_cfg.update(dict(by_epoch=True, max_epochs=20, val_interval=5))
...
test_dataloader.merge(
    dict(
        dataset=dict(
            pipeline=test_pipeline, metainfo=dict(classes=known_classes, unknown_classes=unknown_classes),
            filter_unknowns=True,
            )))
